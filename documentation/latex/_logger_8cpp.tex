...
{\footnotesize\ttfamily void log\+\_\+thr (\begin{DoxyParamCaption}\item[{string \&}]{s,  }\item[{string \&}]{level }\end{DoxyParamCaption})\hspace{0.3cm}{\ttfamily [inline]}}
...
См. определение в файле Logger.\+cpp строка 74
